...
from aim.models.builder import build_model

from aim.optims.builder import build_optimizer
from aim.utils import load_config
...
parser.add_argument('-c', '--config', default='', type=str, metavar='FILE',
                    help='config file specifying default arguments')
...
def _parse_args():
    ...
    if args_config.config:
        cfg = load_config(args_config.config).config_dict
...
def main():
    ...
    #     **args.opt_kwargs,
    # )
    optimizer = build_optimizer(dict(
        type=create_optimizer_v2,
    ...
    if utils.is_primary(args):
        if args.experiment:
            ...
            exp_name = '-'.join([
                ...
                safe_model_name(args.model['type']),
